...
const (
	...
	DispenseService_CreateClaudeTask_FullMethodName  = "/dispense.DispenseService/CreateClaudeTask"
	...
	DispenseService_ListClaudeTasks_FullMethodName   = "/dispense.DispenseService/ListClaudeTasks"
	DispenseService_StreamTaskLogs_FullMethodName    = "/dispense.DispenseService/StreamTaskLogs"
...
type DispenseServiceClient interface {
	...
	// Claude operations
	CreateClaudeTask(ctx context.Context, in *CreateClaudeTaskRequest, opts ...grpc.CallOption) (*CreateClaudeTaskResponse, error)
	...
	ListClaudeTasks(ctx context.Context, in *ListClaudeTasksRequest, opts ...grpc.CallOption) (*ListClaudeTasksResponse, error)
...
func (c *dispenseServiceClient) CreateClaudeTask(ctx context.Context, in *CreateClaudeTaskRequest, opts ...grpc.CallOption) (*CreateClaudeTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateClaudeTaskResponse)
	err := c.cc.Invoke(ctx, DispenseService_CreateClaudeTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dispenseServiceClient) ListClaudeTasks(ctx context.Context, in *ListClaudeTasksRequest, opts ...grpc.CallOption) (*ListClaudeTasksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListClaudeTasksResponse)
	err := c.cc.Invoke(ctx, DispenseService_ListClaudeTasks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dispenseServiceClient) StreamTaskLogs(ctx context.Context, in *StreamTaskLogsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamTaskLogsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DispenseService_ServiceDesc.Streams[1], DispenseService_StreamTaskLogs_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DispenseService_StreamTaskLogsClient = grpc.ServerStreamingClient[StreamTaskLogsResponse]
...
type DispenseServiceServer interface {
	...
	// Claude operations
	CreateClaudeTask(context.Context, *CreateClaudeTaskRequest) (*CreateClaudeTaskResponse, error)
	...
	ListClaudeTasks(context.Context, *ListClaudeTasksRequest) (*ListClaudeTasksResponse, error)
...
func (UnimplementedDispenseServiceServer) CreateClaudeTask(context.Context, *CreateClaudeTaskRequest) (*CreateClaudeTaskResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateClaudeTask not implemented")
}
...
func (UnimplementedDispenseServiceServer) ListClaudeTasks(context.Context, *ListClaudeTasksRequest) (*ListClaudeTasksResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListClaudeTasks not implemented")
}
func (UnimplementedDispenseServiceServer) StreamTaskLogs(*StreamTaskLogsRequest, grpc.ServerStreamingServer[StreamTaskLogsResponse]) error {
...
func _DispenseService_CreateClaudeTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateClaudeTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DispenseServiceServer).CreateClaudeTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DispenseService_CreateClaudeTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DispenseServiceServer).CreateClaudeTask(ctx, req.(*CreateClaudeTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DispenseService_ListClaudeTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListClaudeTasksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DispenseServiceServer).ListClaudeTasks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DispenseService_ListClaudeTasks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DispenseServiceServer).ListClaudeTasks(ctx, req.(*ListClaudeTasksRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DispenseService_StreamTaskLogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamTaskLogsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DispenseServiceServer).StreamTaskLogs(m, &grpc.GenericServerStream[StreamTaskLogsRequest, StreamTaskLogsResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DispenseService_StreamTaskLogsServer = grpc.ServerStreamingServer[StreamTaskLogsResponse]
...
var DispenseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateClaudeTask",
			Handler:    _DispenseService_CreateClaudeTask_Handler,
		},
		{
		...
		{
			MethodName: "ListClaudeTasks",
			Handler:    _DispenseService_ListClaudeTasks_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _DispenseService_StreamTaskLogs_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "internal/grpc/proto/dispense.proto",
}
